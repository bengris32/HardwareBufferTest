...
public class MainActivity extends AppCompatActivity {
    ...
    private void CreateHwBuffer() {
        ...
        try {
            ...
            Log.i(TAG, "HardwareBuffer created and wrapHardwareBuffer failed! All okay.");
            return;
        }

        mTextView.setText(R.string.string_wrapHardwareBuffer_succeeded);
        Log.e(TAG, "wrapHardwareBuffer() succeeded when it shouldn't have...");
    }
}
